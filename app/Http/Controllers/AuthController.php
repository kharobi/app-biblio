...
class AuthController extends Controller {
    ...
    public function signup(Request $request){
        ...
        if($validators->fails()){
            ...
            $user->save();
            auth()->login($user);
            return redirect()->intended(route('ecommerce.products','en'))->with('message','Registration was successfull !');            
        }
    }
    ...
    public function authenticate(Request $request){
        ...
        if($validators->fails()){
            ...
            if(Auth::attempt(['email'=>$request->email,'password'=>$request->password])){
                ...
                return redirect()->intended(route('ecommerce.products','en'))->with('message','Welcome back !');
            }else{
