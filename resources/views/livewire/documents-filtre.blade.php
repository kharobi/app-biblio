                    ...
                    <div class="widget mb-lg-30" id="col-filter">
                        <div class="widget-header-title px-20 py-15 c-filter">
                            <h6 class="d-flex align-content-center fw-500">
                                <img src="{{ asset('assets/img/svg/sliders.svg') }}" alt="sliders" class="svg"> تصنيفات
                                الكتب
                            </h6>
                        </div>
                        <div class="category_sidebar">
                            ...
                            <aside class="product-sidebar-widget mb-30" id="c-type">
                                <div class="widget_title" data-bs-toggle="collapse"
                                    data-bs-target="#multiCollapseExample2" role="button" aria-expanded="true">
                                    <h6>حسب الإختصاص</h6>
                                </div>
                                    ...
                                    <div class="product-category limit-list-item">
                                        <ul>
                                            <div class="w-100">
                                                ...
                                                <p class="fs-14 color-gray"><a href="#c-search"
                                                        wire:click="selectType(null)">جميع الإختصاصات</a></p>
                                            ...
                                            <li>
                                                <div class="row">
                                                    <div class="col-md-9">
                                                        ...
                                                        <p class="fs-14 color-gray"><a href="#c-search"
                                                                wire:click="selectType({{ $type->id }})">{{ $type->libelle_type }}</a>
                                                        </p>

                                                    </div>

                                                    <div class="col-md-3">
                                                        <p class="text-warning">(12)</p>
                                                    </div>
                                                </div>
                            ...
                            <aside class="product-sidebar-widget mb-30" id="c-type">
                                <div class="widget_title" data-bs-toggle="collapse"
                                    data-bs-target="#multiCollapseExample3" role="button" aria-expanded="true">
                                    <h6>حسب الإختصاص</h6>
                                </div>
                                <div class="card border-0 shadow-none multi-collapse mt-10 collapse show"
                            ...
                            <aside class="product-sidebar-widget mb-30" id="c-type">
                                <div class="widget_title" data-bs-toggle="collapse"
                                    data-bs-target="#multiCollapseExample4" role="button" aria-expanded="true">
                                    <h6>حسب الإختصاص</h6>
                                </div>
                                <div class="card border-0 shadow-none multi-collapse mt-10 collapse show"
                        ...
                        <div class="project-top-wrapper d-flex flex-wrap align-items-center">
                            <div class="project-top-left d-flex flex-wrap align-items-center">
                                ...
                                <div class="project-search shop-search  global-shadow " id="c-search">
                                    <form action="/" class="d-flex align-items-center user-member__form">
                                        ...
                                        <input class="" wire:model="query" wire:keyup.debounce="filter" type="search"
                                            placeholder="عنوان الكتاب او المؤلف..." aria-label="Search">
                                    </form>
                                </div>
                                {{-- search bouton --}}
                            ...
                            {{-- <div class="project-top-right d-flex flex-wrap align-items-center">
                                           ...
                                           <ul class="nav px-1 " id="ap-tab" role="tablist">
                                               ...
                                               <li class="nav-item">
                                               <a class="nav-link" id="draft-tab" data-bs-toggle="" href="{{ route('ecommerce.add_product',app()->getLocale()) }}"
                            role="tab" aria-controls="draft" aria-selected="false">add product</a>
                            </li>
                        ...
                        <div class="listing-social-link listing-social-link__products pb-lg-0 pb-xs-2">
                            <div class="icon-list-social d-flex">
                                ...
                                <a class="icon-list-social__link rounded-circle icon-list-social__style justify-content-center  "
                                    href="{{ route('ecommerce.product_list',app()->getLocale()) }}">
