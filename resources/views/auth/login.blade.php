...
<head>
    ...
    <title>{{ $title }} ESG Bibliotheque</title>
                            ...
                            <div class="card border-0">
                                    ...
                                    <form action="{{ route('authenticate') }}" method="POST">
                                        ...
                                        <div class="edit-profile__body">
                                            ...
                                            <div class="admin-condition">
                                                ...
                                                <a href="{{ route('forget_password') }}" class="color-success">forget password?</a>
                                            </div>
                                            <div class="admin__button-group button-group d-flex pt-1 justify-content-md-start justify-content-center">
                                                <button type="submit" class="btn btn-success btn-default w-100 btn-squared text-capitalize lh-normal px-50 signIn-createBtn ">
                                                    sign in
                                                </button>
                                            </div>
                                        </div>
                                ...
                                <div class="admin-topbar">
                                    <p class="mb-0">
                                        ...
                                        <a href="{{ route('register') }}" class="color-success">
                                            Sign up
                                        </a>
                                    </p>
                                </div>
