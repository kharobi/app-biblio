{{-- <div class="container mt-5">
    <div id="bookCarousel" class="carousel slide" data-bs-ride="carousel" data-bs-interval="2000">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <div class="row">
                    <div class="col">
                        <img src="https://placekitten.com/400/200" alt="Couverture du Livre" class="img-standard mx-auto d-block mt-2">
                        <h5>Titre du Livre 1</h5>
                        <p>Description du Livre 1.</p>
                    </div>
                    <div class="col">
                        <img src="https://placekitten.com/401/200" alt="Couverture du Livre" class="img-standard mx-auto d-block mt-2">
                        <h5>Titre du Livre 2</h5>
                        <p>Description du Livre 2.</p>
                    </div>
                    <div class="col">
                        <img src="https://placekitten.com/401/200" alt="Couverture du Livre" class="img-standard mx-auto d-block mt-2">
                        <h5>Titre du Livre 3</h5>
...
<?php $docs = $documents->reverse()->take(4) ?>
<div class="container">
