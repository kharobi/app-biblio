...
<div class="container mt-4 mb-4">
    ...
    <form action="{{ route('ecommerce.store_product','en') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="addProduct" name="title" required autofocus>
        </div>
        <div class="mb-3">
            <label for="content" class="form-label text-dark">Contenu (Résumé)</label>
            <textarea class="form-control" id="addProducttext" name="content" rows="4" required></textarea>
        </div>
        <div class="mb-3">
            <label for="author" class="form-label text-dark">Auteur</label>
            <input type="text" class="form-control" id="addProduct" name="author" required>
        </div>
        <div class="mb-3">
            <label for="author" class="form-label text-dark">Type</label>
            <select class="form-control" id="addProduct" name="type" required>
        ...
        <div class="mb-3">
            ...
            <input type="file" class="form-control" id="addProduct" name="cover_image" accept="image/*" required>
        </div>
        <div class="mb-3">
            <label for="document_file" class="form-label text-dark">Fichier PDF</label>
            <input type="file" class="form-control" id="addProduct" name="document_file" accept=".pdf" required>
        </div>
